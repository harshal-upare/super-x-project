package com.desgin.view.operator.profile;
...
public class ProfileManagement {
    ...
    public HBox getProfile(StackPane root) {
        ...
        notificationBtn1
                .setStyle("-fx-background-color: transparent;" + "-fx-background-radius: 10;" + "-fx-border-width: 0;"
                        + "-fx-border-color: transparent;" + "-fx-text-fill: #5C4033;" + "-fx-font-family: 'Poppins';"
                        + "-fx-font-size: 14px;" + "-fx-font-weight: normal;" + "-fx-cursor: hand;");
        ...
        Text profileName = new Text("Swapnil");
        profileName.setStyle("-fx-font-family: 'Poppins';" + "-fx-font-size: 14px;" + "-fx-font-weight: bold;"
                + "-fx-fill: #4A2C20;");

        Text profileRole = new Text("Operator");
        profileRole.setStyle("-fx-font-family: 'Poppins';" + "-fx-font-size: 11px;" + "-fx-fill: #806A5B;");
...
closeButton.setOnMouseEntered(e -> {
    ...
    closeButton.setStyle(
        ...
        profileBox.setStyle("-fx-background-color: #EDE3D5;" + "-fx-background-radius: 10; -fx-padding: 20px 20px;");
    ...
    private static void hoverElement(Node node) {
    ...
    public static ScrollPane profilePopup() {
        ...
        TextField nameField = new TextField("Swapnil");
        nameField.setPromptText("Full Name");

        TextField emailField = new TextField("swapnil@gmail.com");
