...
public class ProviderAnalytics {
    ...
    public static ScrollPane getAnalyticsSection() {
        ...
        HBox kpiRow = new HBox(15,
            ...
            createMetricCard("🔁 Repeat Farmer Rate", "64.2%", "High customer loyalty", "#5C4033"),
            createMetricCard("⚡ Avg Daily Revenue", "₹4,150 / day", "Across all 18 machines", "#4A2C20"),
    ...
    private static VBox createUtilizationCard() {
        ...
        VBox r1 = createProgressRow("🌾 Combine Harvesters (Kartar & Preet)", "88% Days Booked", 0.88, "#8B6F47");
    ...
    private static VBox createSeasonalDemandCard() {
        ...
        rabi.setStyle("-fx-font-family: 'Poppins'; -fx-font-size: 12.5px; -fx-fill: #5C4033;");

        Text summer = new Text("☀️ Summer Land Prep (Feb - May): Cultivators, Deep Ploughs, and Laser Levelers.");
        summer.setStyle("-fx-font-family: 'Poppins'; -fx-font-size: 12.5px; -fx-fill: #806A5B;");
    ...
    private static VBox createRatingPill(String stars, String count, String color) {
        ...
        c.setStyle("-fx-font-family: 'Poppins'; -fx-font-size: 11px; -fx-fill: #5C4033;");
